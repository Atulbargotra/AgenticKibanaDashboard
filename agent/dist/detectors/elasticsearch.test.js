...
describe("elasticsearchSearch", () => {
    ...
    it("sends POST with correct URL, headers, and body", async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith("http://localhost:9200/my-index/_search", {
            method: "POST",
    ...
    it("throws on non-ok response with status and body", async () => {
        ...
        await expect(elasticsearchSearch("idx", {})).rejects.toThrow("HTTP POST http://localhost:9200/idx/_search failed: 400 Bad Request body");
        vi.unstubAllGlobals();
    });
});
