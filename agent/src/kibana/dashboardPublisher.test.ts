...
} from "./dashboardPublisher.js";
import { kibanaRequest } from "./client.js";
import type { PatternFinding, DashboardPlan } from "../types/domain.js";
...
describe("buildVisualizationState", () => {
  it("returns a metric visualization with count agg", () => {
    ...
    const aggs = state.aggs as Array<Record<string, unknown>>;
  ...
  it("returns a histogram with terms agg for bar with breakdown", () => {
    ...
    const params = aggs[1].params as Record<string, unknown>;
